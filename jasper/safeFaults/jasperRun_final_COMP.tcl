...
analyze -verilog -v "/home/g.vilarde/syn_libraries/15nm/verilog/NanGate_15nm_OCL_functional.v" [dglob "../../GL/COMPARATOR.v"]
...
check_fsv -report -type {sa0 sa1} -text COMP/struct_total_all.txt

check_fsv -report -class safe         -text COMP/struct_safe_ones.txt
check_fsv -report -class unprocessed  -text COMP/struct_unprocessed_ones.txt
check_fsv -report -class dangerous    -text COMP/struct_dangerous_ones.txt

## Unknown means that these are the ones to analyse during fault campaigns.

check_fsv -report -class unknown      -text COMP/struct_unknown_ones.txt
...
check_fsv -report -type {sa0 sa1} -text COMP/active_analysis_total_all.txt

check_fsv -report -class safe         -text COMP/active_analysis_safe_ones.txt
check_fsv -report -class unprocessed  -text COMP/active_analysis_unprocessed_ones.txt
check_fsv -report -class dangerous    -text COMP/active_analysis_dangerous_ones.txt

## Unknown means that these are the ones to analyse during fault campaigns.

check_fsv -report -class unknown      -text COMP/active_analysis_unknown_ones.txt
...
check_fsv -report -type {sa0 sa1} -text COMP/propagation_analysis_total_all.txt

check_fsv -report -class safe         -text COMP/propagation_analysis_safe_ones.txt
check_fsv -report -class unprocessed  -text COMP/propagation_analysis_unprocessed_ones.txt
check_fsv -report -class dangerous    -text COMP/propagation_analysis_dangerous_ones.txt
	
## Unknown means that these are the ones to analyse during fault campaigns.
	
check_fsv -report -class unknown      -text COMP/propagation_analysis_unknown_ones.txt
