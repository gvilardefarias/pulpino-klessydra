...
analyze -verilog -v "/home/g.vilarde/syn_libraries/15nm/verilog/NanGate_15nm_OCL_functional.v" [dglob "../../GL/SHIFTER.v"]
...
check_fsv -report -type {sa0 sa1} -text SHIFT/struct_total_all.txt

check_fsv -report -class safe         -text SHIFT/struct_safe_ones.txt
check_fsv -report -class unprocessed  -text SHIFT/struct_unprocessed_ones.txt
check_fsv -report -class dangerous    -text SHIFT/struct_dangerous_ones.txt

## Unknown means that these are the ones to analyse during fault campaigns.

check_fsv -report -class unknown      -text SHIFT/struct_unknown_ones.txt
...
check_fsv -report -type {sa0 sa1} -text SHIFT/active_analysis_total_all.txt

check_fsv -report -class safe         -text SHIFT/active_analysis_safe_ones.txt
check_fsv -report -class unprocessed  -text SHIFT/active_analysis_unprocessed_ones.txt
check_fsv -report -class dangerous    -text SHIFT/active_analysis_dangerous_ones.txt

## Unknown means that these are the ones to analyse during fault campaigns.

check_fsv -report -class unknown      -text SHIFT/active_analysis_unknown_ones.txt
...
check_fsv -report -type {sa0 sa1} -text SHIFT/propagation_analysis_total_all.txt

check_fsv -report -class safe         -text SHIFT/propagation_analysis_safe_ones.txt
check_fsv -report -class unprocessed  -text SHIFT/propagation_analysis_unprocessed_ones.txt
check_fsv -report -class dangerous    -text SHIFT/propagation_analysis_dangerous_ones.txt
	
## Unknown means that these are the ones to analyse during fault campaigns.
	
check_fsv -report -class unknown      -text SHIFT/propagation_analysis_unknown_ones.txt
