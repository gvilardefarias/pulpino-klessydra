...
analyze -verilog -v "/home/g.vilarde/syn_libraries/15nm/verilog/NanGate_15nm_OCL_functional.v" [dglob "../../GL/ACCUMULATOR.v"]
...
check_fsv -strobe -add {dsp_out_accum_results} -functional
...
check_fsv -report -type {sa0 sa1} -text ACCU/struct_total_all.txt

check_fsv -report -class safe         -text ACCU/struct_safe_ones.txt
check_fsv -report -class unprocessed  -text ACCU/struct_unprocessed_ones.txt
check_fsv -report -class dangerous    -text ACCU/struct_dangerous_ones.txt

## Unknown means that these are the ones to analyse during fault campaigns.

check_fsv -report -class unknown      -text ACCU/struct_unknown_ones.txt
...
check_fsv -report -type {sa0 sa1} -text ACCU/active_analysis_total_all.txt

check_fsv -report -class safe         -text ACCU/active_analysis_safe_ones.txt
check_fsv -report -class unprocessed  -text ACCU/active_analysis_unprocessed_ones.txt
check_fsv -report -class dangerous    -text ACCU/active_analysis_dangerous_ones.txt

## Unknown means that these are the ones to analyse during fault campaigns.

check_fsv -report -class unknown      -text ACCU/active_analysis_unknown_ones.txt
...
check_fsv -report -type {sa0 sa1} -text ACCU/propagation_analysis_total_all.txt

check_fsv -report -class safe         -text ACCU/propagation_analysis_safe_ones.txt
check_fsv -report -class unprocessed  -text ACCU/propagation_analysis_unprocessed_ones.txt
check_fsv -report -class dangerous    -text ACCU/propagation_analysis_dangerous_ones.txt
	
## Unknown means that these are the ones to analyse during fault campaigns.
	
check_fsv -report -class unknown      -text ACCU/propagation_analysis_unknown_ones.txt
