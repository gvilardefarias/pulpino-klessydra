...
analyze -verilog -v "/home/g.vilarde/syn_libraries/15nm/verilog/NanGate_15nm_OCL_functional.v" [dglob "../../GL/MULTIPLIER.v"]
...
check_fsv -strobe -add {dsp_out_mul_results} -functional
...
check_fsv -report -type {sa0 sa1} -text MULT/propagation_analysis_total_all.txt

check_fsv -report -class safe         -text MULT/propagation_analysis_safe_ones.txt
check_fsv -report -class unprocessed  -text MULT/propagation_analysis_unprocessed_ones.txt
check_fsv -report -class dangerous    -text MULT/propagation_analysis_dangerous_ones.txt
	
## Unknown means that these are the ones to analyse during fault campaigns.
	
check_fsv -report -class unknown      -text MULT/propagation_analysis_unknown_ones.txt
