...
// add after paper
unsigned int ops_out32[12][N_ROW_1][N_COL_2];
unsigned int ops_out16[12][N_ROW_1][N_COL_2];
unsigned int ops_out8 [12][N_ROW_1][N_COL_2];
...
int main(){
  ...
  __asm__("csrrw zero, mcycle, zero");
	...
	if(th_id == 2){
		...
		kmemstr((void *)((int *) &ops_out16[1][0]), (void *)((int *)addrC), SIZE_OF_INT * m);
