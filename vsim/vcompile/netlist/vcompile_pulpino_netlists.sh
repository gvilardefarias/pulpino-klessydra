...
set IP=pulpino_kless_netlist_timing
set IP_NAME="PULPino_Kless_Netlist_Timing"
...
# Source
vlog -quiet -work ${LIB_PATH} ${NETLIST_PATH}/kless_timing/tb_time_impl.v    || goto error
